...
import ManagementItem from '../../../../domain/management-item/models/management-item';
...
export default function (managementItemActions) {
  ...
  const component = React.createClass({
    ...
    onSubmit(event){
      ...
      validation.validate(valid => {
        ...
        managementItemActions.save(this.state.formData);
      });
    },
