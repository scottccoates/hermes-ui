          ...
          <div id="new-mi-wrapper">
              ...
              <div className="col-md-12">
                ...
                <form className="form-horizontal mi-form-data-entry">
                  <div className="form-group section-item">
                    <label htmlFor="mi-form-contract-name" className="col-sm-3 control-label">Contract Name</label>
                    <div className="col-sm-9">
                      <input type="text" className="form-control" id="mi-form-contract-name"/>
                    </div>
                  </div>
                  <div className="form-group section-item">
                    <label htmlFor="mi-form-counterparty" className="col-sm-3 control-label">Counterparty</label>
                    <div className="col-sm-9">
                      <input type="text" className="form-control" id="mi-form-counterparty"/>
                    </div>
                  </div>
                  <div className="form-group section-item">
                    <label htmlFor="mi-form-description" className="col-sm-3 control-label">Brief Description</label>
                    <div className="col-sm-9">
                      <textarea rows="5" className="form-control" id="mi-form-description"/>
                    </div>
                  </div>
                  <div className="form-group section-item">
                    <label htmlFor="mi-form-contract-type" className="col-sm-3 control-label">Contract Type</label>
                    <div className="col-sm-9">
            ...
            <section className="row mi-form-section section-container">
              <div className="col-md-12">
                ...
                <form className="form-horizontal mi-form-data-entry">
                  <div className="form-group section-item">
                    <label htmlFor="mi-form-contract-term-length" className="col-sm-3 control-label">Initial Term Length</label>
            ...
            <section className="row mi-form-section section-container">
              <div className="col-md-12">
                ...
                <form className="form-horizontal mi-form-data-entry">
                  <div className="form-group section-item">
                    <label htmlFor="mi-form-contract-term-length" className="col-sm-3 control-label">Cash Flow</label>
                    <div className="col-sm-3">
