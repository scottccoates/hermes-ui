              ...
              <div className="col-sm-12">
                ...
                <div className="section-item">
                  <div className="simple-container">
                    ...
                    <div className="col-sm-11 task-content">
                      <span>The&nbsp;
                    ...
                    <div className="col-sm-2 task-action task-action-done">
                      Done
                    </div>
                    <div className="col-sm-2 task-action task-action-snooze">
                      Snooze
                    </div>
                    <div className="col-sm-2 task-action task-action-edit">
                      Edit
                    </div>
                  </div>
                </div>
